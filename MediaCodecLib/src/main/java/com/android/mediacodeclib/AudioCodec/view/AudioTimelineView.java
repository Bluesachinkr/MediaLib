package com.android.mediacodeclib.AudioCodec.view;
...
public class AudioTimelineView extends View {
    ...
    public AudioTimelineView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        playedStatePainting.setColor(ContextCompat.getColor(getContext(), R.color.colorTextGray));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        height = getContext().getResources().getDimensionPixelOffset(R.dimen.frames_video_height);
    }
